...
exports.Social_attitude = void 0;
...
const Spectrogram_1 = __importDefault(require("./Spectrogram"));
var Social_attitude;
(function (Social_attitude) {
    Social_attitude["Distant"] = "a2";
    Social_attitude["Dominant"] = "a3";
    Social_attitude["Friendly"] = "a1";
    Social_attitude["Seductive"] = "a4";
    Social_attitude["Unknown"] = "unknown";
})(Social_attitude || (exports.Social_attitude = Social_attitude = {}));
class OpenSLR_org_88 {
    static _Test_model() {
    ...
    static Test() {
        const datum0 = Spectrogram_1.default.Load(OpenSLR_org_88.Test_data[0]); // length 70912
        const datum1 = Spectrogram_1.default.Load(OpenSLR_org_88.Test_data[1]); // length 88448
        const datum2 = Spectrogram_1.default.Load(OpenSLR_org_88.Test_data[2]); // length 107008
    ...
    static Get() {
        fetch(OpenSLR_org_88.URL).then((response) => {
            if ('body' in response) { // 'response.body' is a 'ReadableStream' object:
                ...
                const uncompressed_data_stream = response.body.pipeThrough(new DecompressionStream(DMiNer_1.Compression.GZIP));
                ...
                // @ts-ignore
                const source = node_stream_1.Readable.fromWeb(uncompressed_data_stream);
    ...
    static _Audio_file_processing(datum, audio_file_name) {
        ...
        audio_stream.on('data', (chunk) => {
            ...
            _audio.set(chunk, audio.byteLength); // Add...
            audio = _audio; // Update...
        });
    }
    static async Data() {
            ...
            await tar.list({
                ...
                onReadEntry: entry => {
                    ...
                    if (data.data.length > 6)
                        return;
                    const audio_file_name = node_path_1.default.basename(entry.path);
                    ...
                    data.data.push({
                        ...
                        social_attitude: social_attitude_key === Social_attitude.Distant ? Object.keys(Social_attitude)[Object.values(Social_attitude).indexOf(Social_attitude.Distant)]
    ...
    static async _Get_data() {
        await fetch(OpenSLR_org_88.URL).then(async (response) => {
            if ('body' in response) {
                ...
                // Conversion from Web 'ReadableStream' to file system 'ReadStream' (https://stackoverflow.com/questions/71509505/how-to-convert-web-stream-to-nodejs-native-stream):
                // @ts-ignore
                const source = node_stream_1.Readable.fromWeb(response.body); // Compressed data stream...
                ...
                await (0, node_util_1.promisify)(node_stream_1.pipeline)(source, zlib.createUnzip(), target).catch((error) => {
...
OpenSLR_org_88.Test_data = [
    node_path_1.default.join(node_path_1.default.resolve(__dirname, '../../../DATA/gitlab.com_nicolasobin_att-hack/'), "F01_a1_s008_v01.wav"),
    node_path_1.default.join(node_path_1.default.resolve(__dirname, '../../../DATA/gitlab.com_nicolasobin_att-hack/'), "F08_a4_s015_v03.wav"),
    node_path_1.default.join(node_path_1.default.resolve(__dirname, '../../../DATA/gitlab.com_nicolasobin_att-hack/'), "F08_a4_s039_v04.wav")
];
OpenSLR_org_88.Archive_file_name = "OpenSLR_org_88";
OpenSLR_org_88.Path = "Volumes/CLEM_HDD/IRCAM/Open_SLR/wav/";
OpenSLR_org_88.URL = "https://www.openslr.org/resources/88/wav.tgz";
OpenSLR_org_88.Ages = new Map([
    ["F01", "47"],
    ["F02", "43"],
    ["F03", "51"],
    ["M04", "43"],
...
OpenSLR_org_88.Sentences = new Array("oui", "non", "certes", "bien-sûr", "salut", "bonjour", "bonsoir", "tant pis", "très bien", "c’est vrai", "par ici", "au revoir", "à demain", "impossible", "volontiers", "j'ai toussé", "peu importe", "nous partons", "bonne journée", "bonsoir jeanne", "faites leur signe", "asseyez vous", "évidemment", "assurément", "il est midi", "salut marie", "tu as marché", "au revoir yann", "bonjour marie", "ta soeur a bu", "à demain paul", "il faisait bon", "je pars demain", "par ici jeanne", "je pars ce soir", "elle a pris peur", "sans aucun doute", "je prends le temps", "veuillez me croire", "donc fais moi signe", "je prends une pause", "faites lui confiance", "donne leur une chance", "vous avez dormi", "je suis parti tôt", "nous avons chanté", "nous avons eu peur", "veuillez m'écouter", "bonne journée marie", "donne moi une réponse", "il est tard à londres", "je pars tout de suite", "veuillez vous asseoir", "faisons leur confiance", "tu as pris la fuite", "faites moi donc une offre", "vous avez réfléchi", "il est tôt à new-york", "il est tard à paris", "donne moi une occasion", "tu as dit la même chose", "vous avez pris le temps", "il est tard à lisbonne", "nous allons prendre un verre", "laisse moi une deuxième chance", "elle est partie pour bale", "tu es parti en week-end", "tu as oublié ma veste", "elle a oublié ma fête", "je suis parti loin d'ici", "j'ai toussé toute la soirée", "je suis parti sans trainer", "tu as marché toute la nuit", "tu es parti pour l'espagne", "vous êtes allés à la plage", "elle est partie en vacances", "nous allons attendre un peu", "nous allons prendre un café", "ta soeur a bu toute la nuit", "vous êtes partis rapidement", "c’est vrai attendons un peu", "il faisait froid aujourd'hui", "nous allons prendre la fuite", "vous êtes partis en week-end", "certes attendons qu'il arrive", "il fait lourd ce soir à londres", "nous allons prendre des vacances", "vous avez oublié mon verre", "elle a dit ce que je voulais", "elle est allée à la montagne", "il fait beau ce soir à paris", "impossible attendons un peu", "tu as fait ce que je voulais", "elle a fait ce que je voulais", "vous avez dormi toute la nuit", "vous avez dit ce qu'il fallait", "vous avez fait ce qu'il fallait", "nous allons attendre qu'il arrive", "nous allons prendre notre journée", "c’est vrai allons prendre un café");
exports.default = OpenSLR_org_88;
//# sourceMappingURL=OpenSLR_org_88.js.map